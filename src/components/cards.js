export default [
  ...
  },
  {
    ...
    "details": "3D levels created in C#/Unity, transpiled to customized WebGL/JavaScript templates, distributed by CDN, communicating through iframes to a Dockerized Wordpress instance, using SAML service for authentication, relaying scores and user data to a Node API, and much much more crazyness.",
    "tags": [
      "Unity",
      "C#",
      "Docker",
    ...
    "heroImg": "img/portfolio-droneracing@2x.jpg",
    "logoImg": "http://placehold.it/64x64",
  ...
  },
  {
    ...
    "details": "This is a visualization I created with the Amazon AWS team and Intel. It was distributed locally on a giant touch screen with a specific resolution so please excuse the non-responsiveness, ratio weirdness, and instructional animation load times.",
    "tags": ["THREE.js", "WebGL", "Redux", "React", "Firebase"],
  ...
  },
  {
    ...
    "logoImg": "http://placehold.it/64x64",
    "title": "Adjoy",
    "url": "http://joymonster.com",
    "urlText": "adjoy.co"
  },
  {
    "description": "The only app that lets you add products with product images to your WooCommerce store!",
    ...
    "heroImg": "img/portfolio-wooproducts@2x.jpg",
    "logoImg": "http://placehold.it/64x64",
    "title": "WooProducts",
  ...
  },
  {
    ...
    "details": "Carbon Native is a UI library my brother and I created for React Native to build our mobile apps with. It's just a bonus that other people in the community like it and use it too.",
    "tags": ["React Native"],
    "heroImg": "img/portfolio-carbonnative@2x.jpg",
    "logoImg": "http://placehold.it/64x64",
    "title": "Carbon Native",
